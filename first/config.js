  ...
  chapters: [
    {
      ...
      image: null,
      description:
        "<a href='https://www.journalism.cuny.edu/centers/center-community-media/' target='_blank'><img src='./images/ccm-logo.png' style='max-width:200px; margin-left: 0 !important;' alt='Center for Community Media logo' /></a><hr class='hr-headline' /><span style='font-size: 0.9em; text-transform: uppercase; color: #15595a;'>Small Business Reporting Fellowship</span><p style='font-weight: 300; font-size: 1.8em;'>First Stories</p><br />In February 2023, the Small Business Reporting Fellowship kicked off with a cohort of journalists from across NYC and the metro area covering the stories of businesses and entrepreneurs in their communities. They cover the ongoing struggles and challenges, whether brought on or worsened by the pandemic, and also the lessons learned, the new opportunities and the successes.<br /><br />Take a tour through the NYC area of the small businesses and owners featured in the first round of the fellowship stories. The location given may be of just one of several businesses profiled in the fellow's story.<br /><br /><span class='note'><a href='https://airtable.com/shrVkHX3gxbhJIoVE/tblFqhLiryOvHz2qb' target='_blank'>Click here</a> to see a list of the stories in the order of this map.</span><hr class='hr-between' /><h4 style='font-family: Roboto Condensed; font-weight: 400; text-transform: uppercase; color: #15595a;'>Scroll down to begin ↓</h4>",
      location: {
        center: [-74.02, 40.71],
        zoom: 9.5, //11.25,
